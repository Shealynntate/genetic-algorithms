...
import { endSimulationEarly, pauseSimulations, resumeSimulations, runSimulation } from '../navigation/navigationSlice'
...
function ActionButtons ({ isActive = false, simulation, sx }: ActionButtonsProps): JSX.Element | null {
  const appState = useSelector((state: RootState) => state.navigation.simulationState)
