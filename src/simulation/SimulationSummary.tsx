  ...
  return (
    <Grid2 container>
      ...
      <Grid2 xs={6} md={6} pr={5}>
        <Typography color='primary' mb={1}>Population</Typography>
          <Box>
            <img
        ...
        <Typography color='primary' mt={1} mb={1}>Crossover</Typography>
        ...
        />
        <Typography color='primary' my={1}>Stop Criteria</Typography>
        <NumberDisplay
      ...
      <Grid2 xs={12} md={6}>
        <Typography color='primary' mb={1}>Mutation</Typography>
        ...
        />
        <Typography color='primary' mb={1}>Selection</Typography>
        <TextDisplay
          value={parameters.population.selection.type}
          text='Type'
          tooltip={'Mechanism for selecting parents:\n-Tournament\n-Roulette\n-Stochastic Universal Sampling\n(more info on Github)'}
        />
        <NumberDisplay
