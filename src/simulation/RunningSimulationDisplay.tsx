...
function RunningSimulationDisplay({
  simulation
}: RunningSimulationDisplayProps): JSX.Element {
  ...
  return (
    <Stack>
      ...
      <Box
        sx={{ display: 'flex', justifyContent: 'space-between', lineHeight: 1 }}
      >
        ...
        <Stack direction="row" spacing={0.5}>
          ...
          <Typography variant="codeCaption">{polygonCount}</Typography>
        </Stack>
        <Stack direction="row" spacing={0.5}>
