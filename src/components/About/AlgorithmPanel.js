...
function AlgorithmPanel() {
  return (
    <Panel label="The Algorithm" px={2} pt={2} pb={2}>
      ...
      <Typography>
        ...
        algorithm, we choose parent(s) (typically two) and breed them to produce two
        new offspring. Breeding consists of two operations: Crossover and Mutation.
      </Typography>
      <SectionTitle>Reproduction</SectionTitle>
      <Typography>
        Crossover - a recombination of the parents&apos; chromosomes to produce two new sets
        in their offspring.
      </Typography>
      <ExampleText>
      ...
      <Typography>
        Mutation - randomly tweaking values in the offspring&apos;s chromosomes to
        introduce more variety
      </Typography>
      <SectionTitle>Replacement</SectionTitle>
      <Typography>
        Lastly, we replace the previous generation of parent with the new generation of children.
        Then the process repeats until we hit our target or run out of time.
      </Typography>
    </Panel>
  );
}
