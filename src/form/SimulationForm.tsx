      ...
      <Grid2 container>
        ...
        <Grid2 xs={12} md={7}>
          ...
          <Grid2 container spacing={2}>
            <Grid2 xs={12} md={6}>
              <Typography color='primary' variant='h5' my={2}>Selection</Typography>
            ...
            <Grid2 xs={12} md={6}>
              <Typography color='primary' variant='h5' my={2}>Crossover</Typography>
              <FormControl fullWidth size='small'>
          ...
          <Typography color='primary' variant='h5' my={2}>Stop Criteria</Typography>
          <Grid2 container spacing={2}>
            <Grid2 xs={12} md={6}>
              <NumberInput
                errors={errors}
